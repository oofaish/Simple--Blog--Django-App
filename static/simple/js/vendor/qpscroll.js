...
;(function ( $, window, document, undefined ) {
    ...
    ***********************************************************/
    ...
    $.fn.qpScroll.defaults = {
                   imagesFolder: 'img/parallax',
                   imagesArray: [],
                   firstSpeed: 5,/*how much slower should the scroll be - 10 means 10 times slowe*/
                   neighbourRatio: 1.05,/*how much faster should the next image go compared to the one before*/
